...
function getRequestData(){
    ...
    return new Promise((resolve, reject)=>{
        try{
            const queryText = `
            SELECT
            json_build_object('request_id', request.id, 'start_time', request.start_time, 'end_time', request.end_time, 'est_duration', request.est_duration, 'status', request.status, 'location_type', request.location_type_id) as request_info,
